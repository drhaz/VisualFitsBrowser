...
public abstract class CooSysComponent extends javax.swing.JComponent implements
    ...
    public void updateRange(double minX, double maxX, double minY, double maxY) {
        ...
        if (log.isDebugEnabled())
            log.debug("Updating range: " + minX + " -> " + maxX + " : " + minY
                    + " -> " + maxY);
     ...
     * @param p Transformed lcoation of the point. Can be null.
     ...
     * @param x2
     * @param y2
     * @param p1 auxiliary Points for intermedaite calculations. It will change
     *           value.
     * @param p2 auxiliary Point for intermedate calculation. It will change value.
     */
    ...
    private void updateTransformation() {
        ...
        if (scaleY != 0 && scaleX != 0)
            try {
                ...
                log.warn("These are the paramters of the forward transform:");
                log.warn("Scale: " + scaleX + " / " + scaleY);
                log.warn("Offsets: " + offsetX + " / " + offsetY);
     ...
     *
     * @param min minimum value of axis range.
     * @param max maximum value of axis range.
    ...
    public void run() {
        ...
        try {
            ...
            log.error("Error while waitingsetting up render trigger");
        }
        ...
        while (renderTrigger != null) {
            try {
                ...
                log.error("Error while waiting for render trigger");
            }
