...
public class StripChartComponent extends org.wiyn.guiUtils.CooSysComponent
	 ...
	 * 
	 * @param n
	 *            The number of datapoints to be hold in the internal FIFO
	 * @param ymin
	 *            the lower bound of the graph
	 * @param ymax
	 *            the upper bound of the graph.
	 */
